...
int main()
{
    ...
    // Ma camera
    mainCamera.position = glm::vec3(0.0, 0.5, -3.0f);
    ...
    ourShader.SetInteger("material.diffuse_tex", 0 );
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::vec3 dirLightPosition = -lightPosition;
        ...
        ourShader.SetVector3f("lightColor", glm::vec3(0.1f));
        ourShader.SetVector3f("lightPos", lightPosition);
        ourShader.SetVector3f("viewPos", mainCamera.position);

        ourShader.SetVector3f("material.ambient", glm::vec3( 1.0f, 0.5f, 0.31f) );
        ourShader.SetVector3f("material.diffuse", glm::vec3( 1.0f, 0.5f, 0.31f) );
        ourShader.SetVector3f("material.specular",glm::vec3( 0.5f) );
        ourShader.SetFloat("material.shininess", 64.0f);

        ourShader.SetVector3f("light.position", lightPosition);
        ourShader.SetVector3f("light.ambient", glm::vec3(0.0f) );
        ourShader.SetVector3f("light.diffuse", glm::vec3(0.5f) ); // darkened
        ourShader.SetVector3f("light.specular", glm::vec3(1.0f) );
        
        ourShader.SetVector3f("directionalLight.direction", dirLightPosition);
